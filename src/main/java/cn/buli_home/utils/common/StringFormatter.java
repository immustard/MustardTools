...
public class StringFormatter {
    ...
    public static String format(String strPattern, Object... argArray) {
        return formatWith(strPattern, StringConstant.EMPTY_JSON, argArray);
    }
    ...
    public static String formatWith(String strPattern, String placeHolder, Object... argArray) {
        if (StringUtils.isEmpty(strPattern) || StringUtils.isEmpty(placeHolder) || ArrayUtils.isEmpty(argArray)) {
            return strPattern;
        }
     ...
     * @since 5.7.10
     */
    public static String format(CharSequence template, Map<String, Object> map, boolean ignoreNull) {
        if (null == template) {
            return null;
        }
        ...
        return StringUtils.replaceTemplate(template.toString(), map);
    }
}
